        ...
        _afterLoad: function() {
            ...
            b.coming = null;
                ...
                case "image":
                    ...
                    break;
                case "swf":if(getOs()==5){e = '<video  controls="controls" autoplay="autoplay" height="600" width="800">'; e=e+'<source src="http://www.tsichuan.com' + g.substring(g.lastIndexOf("flvPlayer.swf?vcastr_file=")+26,g.lastIndexOf("flv"))+ 'mp4" type="video/mp4" codecs="avc1.42E01E, mp4a.40.2">视频</source> </video>';}else{
