...
/***/ "./resources/js/jquery.littlelightbox.js":
/*!***********************************************!*\
  !*** ./resources/js/jquery.littlelightbox.js ***!
  \***********************************************/
...
(function (win, doc, $, undefined) {
  ...
  $.extend(lightbox, {
    defaults: {
      ...
      // Open Animate.
      openMethod: 'fadeIn',
      // including 'changeIn','fadeIn', 'elasticIn'
      openDirect: 'down',
      // Avaliable if openMethod is 'changeIn', 'down', 'up', 'left', 'right' is avaliable.
      openSpeed: 400,
      distance: 200,
      // Avaliable if openMethod is 'changeIn', 200 and 'hide' is avaliable.
      // Close Animate.
      closeMethod: 'fadeOut',
      closeDirect: 'up',
      closeDistance: 'hide',
    ...
    _jump: function _jump(index, direction) {
    ...
    _run: function _run(index) {
      ...
      coming.skin.css('padding', coming.padding[0] + 'px ' + coming.padding[1] + 'px ' + coming.padding[2] + 'px ' + coming.padding[3] + 'px');
    ...
    _afterLoad: function _afterLoad() {
      ...
      $(content).appendTo(current.inner); // create title helper.
      ...
      this._setPosition(this.wrap, false); // Transition
    ...
    bindEvent: function bindEvent() {
      ...
      window.off('.lb').on('resize.lb', this.update); // Binding Key Board Event
    ...
    trigger: function trigger(eventType, obj) {
    ...
    _setDimension: function _setDimension(isAnimate) {
      var that = this,
          width,
          height,
          winWidth,
    ...
    _setPosition: function _setPosition(obj, isAnimate) {
    ...
    _afterLoadIn: function _afterLoadIn() {
      lightbox.isOpen = true; // load prev, next and close btn.
    ...
    _afterLoadOut: function _afterLoadOut() {
      ...
      if (lightbox.isOpen && lightbox.previous) {
        ...
        lightbox.helpers.title.hide(); // initial lightbox status
  ...
  lightbox.trasition = {
    ...
    elasticOut: function elasticOut() {
      var offsetTopRatio = 0.9,
          offsetLeftRatio = 0.8,
...
/***/ 6:
/*!*****************************************************!*\
  !*** multi ./resources/js/jquery.littlelightbox.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! E:\laragon\www\was\resources\js\jquery.littlelightbox.js */"./resources/js/jquery.littlelightbox.js");
